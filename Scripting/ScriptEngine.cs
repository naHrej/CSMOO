...
public class ScriptEngine
{
    ...
    private string PreprocessObjectReferenceSyntax(string originalCode)
    {
        ...
        result = System.Text.RegularExpressions.Regex.Replace(result, methodCallPattern, match =>
        {
            ...
            // Skip if it's a known static type method call (like ObjectResolver.ResolveObject)
