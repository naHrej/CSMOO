...
/// <summary>
/// Instance-based logger implementation for dependency injection
/// </summary>
public class LoggerInstance : ILogger
{
    private readonly IConfig _config;
    private readonly object _lock = new object();
    private bool _logsRotated = false;
    
    public LoggerInstance(IConfig config)
    {
        _config = config;
    }
    ...
    /// </summary>
    private void RotateLogs(string logFilePath, int maxFiles)
    {
        try
        {
    ...
    {
        var config = _config.Logging;
        var serverConfig = _config.Server;
    ...
    /// </summary>
    private void WriteColoredConsole(string message, ConsoleColor color)
    {
    ...
    /// </summary>
    private bool ShouldLog(LogLevel messageLevel, string configuredLevel)
    {
