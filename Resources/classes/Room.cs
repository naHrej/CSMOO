...
//   Resources/functions/classes/room.cs
//
// The system automatically combines verbs from this file with functions
// from Resources/functions/classes/room.cs by class name. Both files
...
public class Room
{
    ...
    // Example:
    // public verb Lock(string direction) { ... }
    // public verb Unlock(string direction) { ... }
}
