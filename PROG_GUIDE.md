...
CSMOO supports two ways to create and manage verbs:

1. **In-game programming** - Traditional MUD-style `@program` command
2. **JSON files** - Modern external file-based definitions with hot-reloading

Both approaches use the same C# scripting engine and have access to the same functionality.
